 ...
 *
 * Zwei Verwendungen: die Papier-Vorschau des Textgroessen-Reglers (README 16)
 * und die Platzhalter-Dokumente im Viewer, solange es keinen Dateicache gibt.
 * Echte Nutzerdokumente bringen ihre eigene Gestaltung mit, die App gestaltet
 * dort nichts. Die Werte stehen hier nur, weil ausserhalb des Themes keine
 * Hex-Codes erlaubt sind — Tokens sind sie ausdruecklich nicht.
 */
export const sampleDocument = {
  paper: '#F6F5F1',
  ink: '#1A1A1A',
  /** Fliesstext auf Papier */
  inkSoft: '#3A3A38',
  /** Beschriftungen, Achsen, Kleingedrucktes */
  inkMuted: '#6B6862',
  accent: '#9A7B2F',
  /** Karte auf dem Papier */
  card: '#FFFFFF',
  /** Zitat- und Hinweisflaeche */
  quote: '#EFEDE4',
  /** Trennlinien und Rahmen auf Papier */
  rule: '#E2DFD6',
  /** Balken im Beispiel-Diagramm */
  bar: '#C9C4B4',
} as const;

/**
 * Die Standardflaeche eines fremden Dokuments — NICHT Teil des Designsystems.
 *
 * Ein HTML-Dokument ohne eigenen Hintergrund ist in jedem Browser weiss; genau
 * diese Flaeche muss der Viewer nach dem Laden zeigen. Die Buehne bleibt bis
 * dahin `bg/base` (Screen 5: "verhindert weisses Aufblitzen beim Laden") —
 * danach gehoert die Flaeche dem Dokument. Sie dunkel zu lassen waere ein
 * Stylesheet ueber fremdem HTML, und schwarzer Text auf `bg/base` ist nicht
 * lesbar.
 */
export const documentCanvas = '#FFFFFF';
