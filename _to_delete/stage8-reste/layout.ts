...
/**
 * Das leere Regal der Erststart-Darstellung (Screen 19, Blatt `4a`).
 *
 * Die Zeichnung besteht aus denselben Flaechen und Linien wie die App — eine
 * Bodenplatte und vier stehende "Baende", einer davon gekippt. Die Masse
 * stehen hier und nicht in der Komponente, weil sie ein Bild ergeben und kein
 * Flex-Verhaeltnis: verschiebt man einen Wert, stimmt das Bild nicht mehr.
 */
export const emptyShelf = {
  ...
  plateHeight: 10,
  volumeWidth: 22,
  /** Hoehen und Abstaende von links, in der Reihenfolge des Blattes. */
  volumes: [
    { left: 14, height: 56 },
    { left: 40, height: 72 },
    { left: 66, height: 46, tilt: '6deg' as const },
    { left: 96, height: 64 },
  ],
  /** Kleiner als `radius xs` — bei 22 dp Breite wirken 6 schon wie Kapseln. */
  radius: 3,
} as const;
